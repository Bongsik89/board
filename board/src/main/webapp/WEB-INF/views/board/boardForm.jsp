		...
		<div class="container" role="main">
			...
			action="${pageContext.request.contextPath}/board/saveBoard">	
				...
				<div class="mb-3">
					...
					<form:input path="title" class="form-control" id="title" placeholder="제목을 입력해주세요" />
				</div>
				...
				<div class="mb-3">
					...
					<form:input path="cate_cd" class="form-control" name="cate_cd" id="cate_cd" placeholder="카테고리를 입력해 주세요" />
				</div>
